...
| 6 | F6: texto saneado en `sanitize_cell_text` — formula injection neutralizado (`=`, `+`, `-`, `@`) y caracteres de control ilegales eliminados, sin alterar fechas ni montos | AC-8 | `app/services/xlsx_export.py::sanitize_cell_text` | `tests/unit/test_h3_3_6_xlsx_export_builder.py::test_formula_trigger_prefixes_neutralized`, `tests/unit/test_h3_3_6_xlsx_export_builder.py::test_no_formula_cells`, `tests/unit/test_h3_3_6_xlsx_export_builder.py::test_sanitize_cell_text_removes_illegal_characters`, `tests/unit/test_h3_3_6_xlsx_export_builder.py::test_control_characters_removed_before_cell_assignment` | — |
| 7 | F7: generación efímera (bytes en memoria, sin persistencia en S3/RDS) con temporal privado de openpyxl eliminado siempre incluso ante error + headers MIME XLSX, Content-Disposition, Cache-Control no-store, X-Content-Type-Options nosniff | AC-11, AC-13 | ruta + `build_xlsx_workbook`/`_save_workbook_ephemerally` (directorio privado `mkdtemp` + `shutil.rmtree` en `finally`) | `tests/unit/test_h3_3_6_export_web.py::test_response_security_headers_and_filename`, `tests/unit/test_h3_3_6_xlsx_export_builder.py::test_failure_during_generation_leaves_no_temp_files` | AC-18 |
| 8 | F8: límite máximo constante, conteo previo y aborto sin truncamiento | AC-10 | `EXPORT_MAX_ROWS` + `SolicitudRepository.count_crm_solicitudes` + `ExportLimitExceededError` | `tests/unit/test_h3_3_6_export_service.py::test_limit_exceeded_aborts_before_fetch`, `tests/unit/test_h3_3_6_export_service.py::test_limit_exact_is_allowed_and_exports`, `tests/unit/test_h3_3_6_export_web.py::test_limit_exceeded_clear_message` | AC-18 |
...
| 10 | F10: UX (botón integrado sin romper Actualizar/Limpiar, mensajes claros de cero/exceso/error) | AC-1, AC-10 | `leads.html` (enlace con `export_url` desde `current_query`) + página de error de límite y de fallo de generación (sin PII) | `tests/unit/test_h3_3_6_export_web.py::test_ceo_and_cto_see_export_button`, `tests/unit/test_h3_3_6_export_web.py::test_limit_exceeded_clear_message`, `tests/unit/test_h3_3_6_export_web.py::test_generation_failure_returns_clear_error_without_pii` | AC-18 |
...
| AC-8 | Formula injection neutralizado (4 prefijos) y caracteres de control ilegales eliminados, sin alterar fechas/montos | `tests/unit/test_h3_3_6_xlsx_export_builder.py::test_formula_trigger_prefixes_neutralized`, `tests/unit/test_h3_3_6_xlsx_export_builder.py::test_no_formula_cells`, `tests/unit/test_h3_3_6_xlsx_export_builder.py::test_sanitize_cell_text_removes_illegal_characters`, `tests/unit/test_h3_3_6_xlsx_export_builder.py::test_control_characters_removed_before_cell_assignment` |
...
| AC-10 | Límite máximo constante; exceso aborta antes de generar con mensaje claro; límite exacto exporta | `tests/unit/test_h3_3_6_export_service.py::test_limit_exceeded_aborts_before_fetch`, `tests/unit/test_h3_3_6_export_service.py::test_limit_exact_is_allowed_and_exports`, `tests/unit/test_h3_3_6_export_web.py::test_limit_exceeded_clear_message` |
| AC-11 | Generación efímera (temporal privado eliminado incluso ante error) + headers MIME/disposition/no-store/nosniff | `tests/unit/test_h3_3_6_export_web.py::test_response_security_headers_and_filename`, `tests/unit/test_h3_3_6_xlsx_export_builder.py::test_failure_during_generation_leaves_no_temp_files` |
